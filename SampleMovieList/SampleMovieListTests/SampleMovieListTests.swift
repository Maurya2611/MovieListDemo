...
class SampleMovieListTests: XCTestCase {
    ...
    func testAsynchronousURLConnection() {
        let URL = "https://api.themoviedb.org/3/movie/now_playing?page=1&api_key=fbf8e1eb83fef3170bdea6402982149c"
